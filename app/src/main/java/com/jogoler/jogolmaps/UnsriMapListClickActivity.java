...
public class UnsriMapListClickActivity extends TileViewActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!obtainLocation())
            ...
            if ((CURRENT_LONGITUDE < NORTH_WEST_LONGITUDE && CURRENT_LONGITUDE > SOUTH_EAST_LONGITUDE) &&
                ...
                markerMyLocation.setScaleX((float) 0.6);
                markerMyLocation.setScaleY((float) 0.6);
                tileView.getMarkerLayout().setMarkerTapListener(markerTapListener);
                tileView.addMarker(markerMyLocation, position[0], position[1], -0.5f, -0.8f);
            } else {
        ...
        //Log.d(TAG, "point[0],point[1] = "+point[0]+","+point[1]+"\nlong,lat = "+longitude+","+ latitude);
        // if(latitude == point[1]) {
        //Log.d(TAG, "Sama");
        // any view will do...
        ArrayList<double[]> points = new ArrayList<>();
        {
            points.add(new double[]{longitude, latitude, R.drawable.targetlocation}); //gate Rumah dinas
        }
        ...
        ArrayList<double[]> home = new ArrayList<>();
